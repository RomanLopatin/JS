...
function showCategory(category) {
    ...
    //         myProducts = products.phones
    //         break;
    //     case 'tablets':
    //         console.log(products.tablets);
    //         myProducts = products.tablets
    //         break;
    //     case 'tv':
    //         console.log(products.tv);
    //         myProducts = products.tv
    //         break;
    // }
    myProducts = products[category]
    for (let myProduct of myProducts) {
        console.log(myProduct);
        //вызов ф-ии getProductMarkup(product)
        let productMarkap = getProductMarkup(myProduct)
        document.querySelector('.products').insertAdjacentHTML('beforeend', productMarkap);
    }
}
